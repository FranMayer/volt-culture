...
import { computePromo2x1 } from './promo2x1.js';
...
export function computeCheckoutTotals(items, shippingOption, shippingConfig, mode, coupon) {
    ...
    // El cupón se bloquea solo si el 2x1 REALMENTE descontó algo: un único item
    // en promo con quantity 1 no forma par, no regala nada, y ahí el cupón sigue
    // valiendo. Gatear por la mera presencia del flag cobraba de más.
    const couponAplicable = coupon && promoDiscount === 0;
