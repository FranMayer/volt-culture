...
export function computePromo2x1(items) {
    ...
    for (const item of items || []) {
        ...
        // Entero positivo o nada: una cantidad fraccionaria (1.01) expandía DOS
        // unidades y regalaba una entera, y un Infinity colgaba el loop. Los
        // endpoints ya normalizan, pero el módulo no puede depender del caller.
        const qtyRaw = Math.floor(Number(item.quantity));
