/**
 * andreani-auth.ts — Autenticación y fetch autenticado contra la API de Andreani.
 * Port literal de api/_andreani-auth.js.
 *
 ...
 * @returns timestamp en ms, o null si no se pudo decodificar.
 */
 ...
 *
 * @param path — path relativo, ej. '/v1/tarifas?cpDestino=5000'
 */
export async function andreaniFetch(path: string, options: RequestInit = {}): Promise<Response> {
