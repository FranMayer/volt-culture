...
//
// 2.5s, no 8s: la función tiene 10s en total y el camino de pago ya hace 8
// llamadas de red secuenciales (MP, 2x Firestore, transacción, 2x Resend,
// CallMeBot). Con 8s acá un WAHA caído se comía casi todo el presupuesto y
// hacía timeoutear el webhook — que fue exactamente lo que pasó en prod.
// Un WhatsApp que no sale en 2.5s no vale un pago reintentado por MP.
